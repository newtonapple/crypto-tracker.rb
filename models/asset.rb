...
#  transferred_in_at           | timestamp without time zone |
...
#  assets_portfolio_id_account_id_currency_id_account_acquired_at_ | btree (portfolio_id, account_id, currency_id, account_acquired_at, amount)
#  assets_portfolio_id_account_id_currency_id_account_average_cost | btree (portfolio_id, account_id, currency_id, account_average_cost_amount, account_acquired_at, amount)
...
#  assets_portfolio_id_currency_id_transferred_in_at_index         | btree (portfolio_id, currency_id, transferred_in_at)
...
class Asset < Sequel::Model
  ...
  TABLE_HEADERS = ['account_id', 'account', 'id', 'type', 'amount', ' ', 'cost', ' ', 'cost_avg', ' ', 'acquired_at'].freeze
  TABLE_ALIGNMENTS = %i[right left left left right left right left right left left].freeze
