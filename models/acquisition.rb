...
#  transferred_assets | transferred_assets_acquisition_id_fkey | (acquisition_id) REFERENCES acquisitions(id)
...
class Acquisition < Sequel::Model
  ...
  def create_asset
    Asset.create(
      ...
      cost_amount:,
      average_cost_amount:,
      account_cost_amount: cost_amount,
      account_average_cost_amount: average_cost_amount,
      type:,
      acquired_at:,
      account_acquired_at: acquired_at
    )
  end
